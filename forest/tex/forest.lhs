...
The rep of a variable may contain other variables. For example, a directory containing a list of other Forest types. TODO by Hugo: write a simple programming example.

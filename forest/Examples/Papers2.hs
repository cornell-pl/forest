...
import Language.Forest.FS.NoFS
...
import Language.Forest.Display
import Language.Pads.Padsc hiding (take,numErrors,head,lift)
import Language.Forest.Class hiding (sources,addDir)
...
--onepaper p = 1
--
--yearVals :: Map String Year -> [String]
--yearVals = Map.keys
--
--authorVals :: Map String Author -> [String]
--authorVals = Map.keys
--
...
papersErrors :: FSRep fs => ((Papers2 fs,Papers2_md fs),LoadInfo fs) -> ForestO fs ()
papersErrors ((rep,md),_) = do
	err <- get_errors md
	forestIO $ print (numErrors err)
	forestIO $ print (errorMsg err)

timeForestNILFS (NILFSForestO (Outer io)) = NILFSForestO $ Outer $ timeIt io
...
papers2_dot_NILFS = do
	...
	runForest (NILFSForestConfig path myDir) $ papers2_dot True path
smallpapers2_pdf_NILFS = runForest (NILFSForestConfig smallpapersNILFSRoot myDir) $ papers2_dot True smallpapersNILFSRoot
...
instance (DeepTypeable (BinaryFile fs :.: BinaryFile_md fs),FSRep fs,Sat (ctx (BinaryFile fs :.: BinaryFile_md fs)),MData ctx (ForestI fs) (Binary :.: Binary_md)) => MData ctx (ForestI fs) (BinaryFile fs :.: BinaryFile_md fs) where
...
binaryFileLensM :: FSRep fs => LensM (ForestI fs) (BinaryFile fs :.: BinaryFile_md fs) (Binary :.: Binary_md)
...
instance (DeepTypeable (Paper fs :.: Paper_md fs),FSRep fs,Sat (ctx (Paper fs :.: Paper_md fs)),MData ctx (ForestI fs) (BinaryFile fs :.: BinaryFile_md fs)) => MData ctx (ForestI fs) (Paper fs :.: Paper_md fs) where
...
paperBinaryFileLensM :: FSRep fs => LensM (ForestI fs) (Paper fs :.: Paper_md fs) (BinaryFile fs :.: BinaryFile_md fs)
paperBinaryFileLensM = lensM (Lens unPaper (\s v -> s { unPaper = v })) `prodFLensM` (fstLensM `compLensM` fstLensM)

instance (DeepTypeable (Supplemental fs :.: Supplemental_md fs),FSRep fs,Sat (ctx (Supplemental fs :.: Supplemental_md fs)),MData ctx (ForestI fs) [Paper fs :.: Paper_md fs]) => MData ctx (ForestI fs) (Supplemental fs :.: Supplemental_md fs) where
...
supplementaFilesLensM :: FSRep fs => LensM (ForestI fs) (Supplemental fs :.: Supplemental_md fs) [Paper fs :.: Paper_md fs]
...
instance (FSRep fs,Sat (ctx (Author fs :.: Author_md fs)),MData ctx (ForestI fs) (Maybe (Supplemental fs :.: Supplemental_md fs)),MData ctx (ForestI fs) [Paper fs :.: Paper_md fs]) => MData ctx (ForestI fs) (Author fs :.: Author_md fs) where
...
authorPapersLensM :: FSRep fs => LensM (ForestI fs) (Author fs :.: Author_md fs) [Paper fs :.: Paper_md fs]
...
authorSupplementalLensM :: FSRep fs => LensM (ForestI fs) (Author fs :.: Author_md fs) (Maybe (Supplemental fs :.: Supplemental_md fs))
...
instance (DeepTypeable (Year fs :.: Year_md fs),FSRep fs,Sat (ctx (Year fs :.: Year_md fs)),MData ctx (ForestI fs) [Author fs :.: Author_md fs]) => MData ctx (ForestI fs) (Year fs :.: Year_md fs) where
...
yearAuthorsLensM :: FSRep fs => LensM (ForestI fs) (Year fs :.: Year_md fs) [Author fs :.: Author_md fs]
...
instance (DeepTypeable (Articles fs :.: Articles_md fs),FSRep fs,Sat (ctx (Articles fs :.: Articles_md fs)),MData ctx (ForestI fs) [Year fs :.: Year_md fs]) => MData ctx (ForestI fs) (Articles fs :.: Articles_md fs) where
...
articleYearsLensM :: FSRep fs => LensM (ForestI fs) (Articles fs :.: Articles_md fs) [Year fs :.: Year_md fs]
...
instance (DeepTypeable (Books fs :.: Books_md fs),FSRep fs,Sat (ctx (Books fs :.: Books_md fs)),MData ctx (ForestI fs) [Year fs :.: Year_md fs]) => MData ctx (ForestI fs) (Books fs :.: Books_md fs) where
...
bookYearsLensM :: FSRep fs => LensM (ForestI fs) (Books fs :.: Books_md fs) [Year fs :.: Year_md fs]
...
instance (DeepTypeable (Media fs :.: Media_md fs),FSRep fs,Sat (ctx (Media fs :.: Media_md fs)),MData ctx (ForestI fs) [Year fs :.: Year_md fs]) => MData ctx (ForestI fs) (Media fs :.: Media_md fs) where
...
mediaYearsLensM :: FSRep fs => LensM (ForestI fs) (Media fs :.: Media_md fs) [Year fs :.: Year_md fs]
...
instance (DeepTypeable (Reports fs :.: Reports_md fs),FSRep fs,Sat (ctx (Reports fs :.: Reports_md fs)),MData ctx (ForestI fs) [Year fs :.: Year_md fs]) => MData ctx (ForestI fs) (Reports fs :.: Reports_md fs) where
...
reportYearsLensM :: FSRep fs => LensM (ForestI fs) (Reports fs :.: Reports_md fs) [Year fs :.: Year_md fs]
...
papers2ArticlesLensM :: FSRep fs => LensM (ForestI fs) (Papers2 fs :.: Papers2_md fs) (Maybe (Articles fs :.: Articles_md fs))
...
papers2BooksLensM :: FSRep fs => LensM (ForestI fs) (Papers2 fs :.: Papers2_md fs) (Maybe (Books fs :.: Books_md fs))
...
papers2MediaLensM :: FSRep fs => LensM (ForestI fs) (Papers2 fs :.: Papers2_md fs) (Maybe (Media fs :.: Media_md fs))
...
papers2ReportsLensM :: FSRep fs => LensM (ForestI fs) (Papers2 fs :.: Papers2_md fs) (Maybe (Reports fs :.: Reports_md fs))
...
papers2LibraryLensM :: FSRep fs => LensM (ForestI fs) (Papers2 fs :.: Papers2_md fs) (Maybe (Library fs :.: Library_md fs))
...
instance (FSRep fs,Sat (ctx (Library fs :.: Library_md fs)),MData ctx (ForestI fs) (BinaryFile fs :.: BinaryFile_md fs)) => MData ctx (ForestI fs) (Library fs :.: Library_md fs) where
...
libraryDatabaseLensM :: FSRep fs => LensM (ForestI fs) (Library fs :.: Library_md fs) (BinaryFile fs :.: BinaryFile_md fs)
...
articlePaperNamesWithYear :: (Memo (ForestJoinListICThunkI fs (Paper fs :.: Paper_md fs)),FSRep fs,ForestOutput fs ICThunk Inside,MData (MemoCtx NoCtx) (ForestI fs) (Papers2 fs :.: Papers2_md fs),MData (MemoCtx NoCtx) (ForestI fs) (Articles fs :.: Articles_md fs),MData (MemoCtx NoCtx) (ForestI fs) (Year fs :.: Year_md fs))
...
--count papers; change something
--topk most prolific authors (by number of papers)

...
doZDefaultSimpleWithConstraint :: (ForestMD fs rep,ForestMD fs content,ForestContent fs rep content,ForestOutput fs ICThunk Inside,Matching fs a,MData NoCtx (ForestI fs) rep) =>

...
doZManifestConstraintInner :: (ForestContent fs rep content,ForestMD fs rep,ICRep fs) =>
...
doZManifestSimpleWithConstraint :: (ForestContent fs rep content,ForestMD fs rep,ICRep fs,Matching fs a) =>

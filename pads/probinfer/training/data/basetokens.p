...
Ptypedef Pstring_ME(:"/((([0-9A-Za-z_\\-]{1,63})\\.)+((com|net|edu|org|gov)|[a-z][a-z]|(com|net|edu|org|gov)\\.[a-z][a-z]))/":) PPhostname;
...
Ptypedef Pstring_ME(:"/[\\\"'])([A-Za-z0-9_\\\\-,;. ])+([\\\"']/":) PPtext;

Ptypedef Pstring_ME(:"/[0-9a-z]+/":) PPhstring;

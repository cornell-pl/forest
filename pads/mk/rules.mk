...
STATIC_PZLIB_O = $(LIBDIR)/$(STATIC_PZLIB_NM_O)
STATIC_BZLIB_O = $(LIBDIR)/$(STATIC_BZLIB_NM_O)
STATIC_ZLIB_O = $(LIBDIR)/$(STATIC_ZLIB_NM_O)
STATIC_DLL_LIB_O = $(LIBDIR)/$(STATIC_DLL_LIB_NM_O)
ifdef USE_PZIP
STATIC_ASTLIB_O = $(STATIC_PZLIB_O) $(STATIC_ZLIB_O) $(STATIC_BZLIB_O) $(STATIC_DLL_LIB_O) $(LIBDIR)/$(STATIC_ASTLIB_NM_O)
else
...
STATIC_PZLIB_D = $(LIBDIR)/$(STATIC_PZLIB_NM_D)
STATIC_BZLIB_D = $(LIBDIR)/$(STATIC_BZLIB_NM_D)
STATIC_ZLIB_D = $(LIBDIR)/$(STATIC_ZLIB_NM_D)
STATIC_DLL_LIB_D = $(LIBDIR)/$(STATIC_DLL_LIB_NM_D)
ifdef USE_PZIP
STATIC_ASTLIB_D = $(STATIC_PZLIB_D) $(STATIC_ZLIB_D) $(STATIC_BZLIB_D) $(STATIC_DLL_LIB_D) $(LIBDIR)/$(STATIC_ASTLIB_NM_D)
else
...
SHARED_PZLIB_DEP_O = $(LIBDIR)/$(SHARED_PZLIB_NM_O)
SHARED_BZLIB_DEP_O = $(LIBDIR)/$(SHARED_BZLIB_NM_O)
SHARED_ZLIB_DEP_O = $(LIBDIR)/$(SHARED_ZLIB_NM_O)
SHARED_DLL_LIB_DEP_O = $(LIBDIR)/$(SHARED_DLL_LIB_NM_O)
ifdef USE_GALAX
...
SHARED_PZLIB_DEP_D = $(LIBDIR)/$(SHARED_PZLIB_NM_D)
SHARED_BZLIB_DEP_D = $(LIBDIR)/$(SHARED_BZLIB_NM_D)
SHARED_ZLIB_DEP_D = $(LIBDIR)/$(SHARED_ZLIB_NM_D)
SHARED_DLL_LIB_DEP_D = $(LIBDIR)/$(SHARED_DLL_LIB_NM_D)
ifdef USE_GALAX

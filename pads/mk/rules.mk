...
ifdef USE_GALAX
PADS_NAME = pads-galax
else
PADS_NAME = pads
endif

STATIC_PADSLIB_NM_O = $(mam_cc_PREFIX_ARCHIVE)$(PADS_NAME)$(mam_cc_SUFFIX_ARCHIVE)
STATIC_PADSLIB_NM_D = $(mam_cc_PREFIX_ARCHIVE)$(PADS_NAME)-g$(mam_cc_SUFFIX_ARCHIVE)
...
SHARED_PADSLIB_NM_O = $(mam_cc_PREFIX_SHARED)$(PADS_NAME)$(mam_cc_SUFFIX_SHARED).1.0
SHARED_PADSLIB_NM_ALT1_O = $(mam_cc_PREFIX_SHARED)$(PADS_NAME)$(mam_cc_SUFFIX_SHARED).1
SHARED_PADSLIB_NM_ALT2_O = $(mam_cc_PREFIX_SHARED)$(PADS_NAME)$(mam_cc_SUFFIX_SHARED)

SHARED_PADSLIB_NM_D = $(mam_cc_PREFIX_SHARED)$(PADS_NAME)-g$(mam_cc_SUFFIX_SHARED).1.0
SHARED_PADSLIB_NM_ALT1_D = $(mam_cc_PREFIX_SHARED)$(PADS_NAME)-g$(mam_cc_SUFFIX_SHARED).1
SHARED_PADSLIB_NM_ALT2_D = $(mam_cc_PREFIX_SHARED)$(PADS_NAME)-g$(mam_cc_SUFFIX_SHARED)

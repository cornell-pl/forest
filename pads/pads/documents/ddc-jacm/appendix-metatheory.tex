...
of \secref{sec:ddc-meta-theory} and state a number of lemmas about \ddc{} which we found essential in constructing those proofs. For more detailed proofs, as well as lemmas and theorems about \fomega{} on which we have relied, we refer the reader to Mandelbaum's thesis~\cite{mandelbaum:thesis}.

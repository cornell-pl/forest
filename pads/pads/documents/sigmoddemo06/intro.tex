...
non-standard or \textit{ad hoc} data formats. \eat{\tblref{figure:data-sources}
...
of elements in a data source, and unions and enums %, switched unions,
...
\eat{times,  integers, floating-point}

\eat{\pads{} descriptions exist for all the data sources in
...
\eat{Details about the \pads{} system are reported in technical
...
\pads{} applications from other application domains.\eat{using the formats in \tblref{figure:data-sources}.}
...
language for describing data formats!  \eat{If lucky, our analyst might be
...
layout of her data.\eat{The language also permits the analyst to
...
in a \pads{} description all that she knows about a given data
source.}  If the analyst is new to \pads{}, she can use the
\launchpads{} interactive interface shown in
\figref{figure:launchpads} to help her create a \pads{} description.
...
%    \scalebox{.2}{\includegraphics{sirius_screenshot1.png}}
    \scalebox{.2}{\includegraphics{sirius_screenshot1.ps}}
  \end{center}
...
which is shown in Figure~\ref{figure:dibbler}\eat{bottom-most frame of Figure~\ref{figure:launchpads},}
...
window,''\eat{``Count the number of orders going through a particular
...
incentive for keeping the descriptions current.\eat{, allowing the descriptions to serve

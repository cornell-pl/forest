...
\numberofauthors{3}
\author{
\alignauthor Mary Fern\'andez \\ Kathleen Fisher\\
\affaddr{AT\&T Labs Research}\\
\email{\{mff,kfisher\}@research.att.com}
\alignauthor Robert Gruber\titlenote{Work carried out while at AT\&T Labs Research.}\\
\affaddr{Google}\\
\email{gruber@google.com}
\alignauthor Yitzhak Mandelbaum \\
\affaddr{Princeton University} \\
\email{yitzhakm@cs.princeton.edu}
}

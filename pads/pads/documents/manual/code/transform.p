/*@FILE @LEFT hexint32.tex trans-toHexString.tex trans-toInt32.tex hexint32withMask.tex */
...
char intToHexChar(Puint32 h){
  if (h < 0 || h > 15) return 'z';  // error!
  if (h >= 0 && h < 10) return '0' + h;
  return 'a' + (h - 10);
}

// Assume argument pointers point to valid space
/*@BEGIN trans-toInt32.tex */

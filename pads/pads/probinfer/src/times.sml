...
struct
    ...
    fun updateStart ( t : time ) ( et : EndingTimes ) : EndingTimes =
        { start = t, tokenEnd = #tokenEnd et, structEnd = #structEnd et, measure1End = #measure1End et
    ...
    fun updateTokenEnd ( t : time ) ( et : EndingTimes ) : EndingTimes =
        { start = #start et, tokenEnd = t, structEnd = #structEnd et, measure1End = #measure1End et
        , reduce1End = #reduce1End et, reduce2End = #reduce2End et
        , reduce3End = #reduce3End et, measure2End = #measure2End et
	, padsEnd = #padsEnd et
        }

    fun updateStructEnd ( t : time ) ( et : EndingTimes ) : EndingTimes =
        { start = #start et, tokenEnd = #tokenEnd et, structEnd = t, measure1End = #measure1End et
        , reduce1End = #reduce1End et, reduce2End = #reduce2End et
        , reduce3End = #reduce3End et, measure2End = #measure2End et
	, padsEnd = #padsEnd et
        }
    ...
    fun updateMeasure1End ( t : time ) ( et : EndingTimes ) : EndingTimes =
        { start = #start et, tokenEnd = #tokenEnd et, structEnd = #structEnd et, measure1End = t
        , reduce1End = #reduce1End et, reduce2End = #reduce2End et
        , reduce3End = #reduce3End et, measure2End = #measure2End et
	, padsEnd = #padsEnd et
        }
    fun updateReduce1End ( t : time ) ( et : EndingTimes ) : EndingTimes =
        { start = #start et, tokenEnd = #tokenEnd et, structEnd = #structEnd et, measure1End = #measure1End et
    ...
    fun sumTimes ( t : ComputeTimes ) : time =
        #token t + #structinfer t + #measure1 t + #reduce1 t + #reduce2 t + #reduce3 t + #measure2 t
	+ #pads t

    fun getComputeTimes ( et : EndingTimes ) : ComputeTimes =
(*    ( print ((toString (#tokenEnd et))^" "^(toString (#structEnd et))^" "^(toString (#measure1End et))^"\n");*)
        { token    = #tokenEnd et - #start et
        , structinfer = #structEnd et - #tokenEnd et
        , measure1 = #measure1End et - #structEnd et
...
(*    )*)
    ...
    fun computeTimesToString ( t : ComputeTimes ) : string =
        let val { token = tok
            ...
            val ln11 = "Structure inference time = " ^ toString si ^ "\n"
            ...
            val ln10 = "============================================================\n"
        in ln1 ^ ln2 ^ ln11 ^ ln3 ^ ln4 ^ ln5 ^ ln6 ^ ln7 ^ ln8 ^ ln9 ^ ln10
        end

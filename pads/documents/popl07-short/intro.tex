...
\edcom{Refer reader to thesis and tech report} presents the extended \ddc{} calculus, focusing on
the semantics of polymorphic types for parsing and the key elements of
the printing semantics.  \cut{We show that both parsers and printers
  in the \ddc{} are type correct and furthermore that printers produce
  pairs of parsed data and parse descriptors in {\em canonical form}.
}

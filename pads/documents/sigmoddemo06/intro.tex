...
The \pads{} compiler produces a customizable library for
...
week. \figref{figure:dibbler-records} contains sample data
...
data sources well.  For example, the XQuery expression below produces
all orders that started in October, 2004.
\begin{code}

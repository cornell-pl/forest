...
% The round-tripping properties obeyed by core \Forest{} programs are
% based on the laws that have been proposed for well-behaved
% lenses~\cite{lenses}. \jnf{Add Philippa's MSc student's thesis if
%   he sends us a link in time.}

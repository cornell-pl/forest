...
type systems, so we based our design on an underlying type theory, 
...
description.  As a bonus, Haskell's quasiquoting mechanism~\cite{Mainland:quasi} proved a
...
In designing the language, we strove to have \forest{}
...
skirting issues of undecidability.  
...
modifications; we leave to future work the possibility of integrating
with the operating system to monitor such changes. 

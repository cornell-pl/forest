...
The validator $\phi'$ produced by the store function does exactly this
...
the information they contain. As a simple example to show why
validators are needed, consider the specification
%

...
The syntax of specifications $s$ in the \forest{} calculus is given in
...
The predicate $\phi'$ produced by the store function does exactly this
...
The rule for path specifications $\SPath{e}{s}$ passes off control to

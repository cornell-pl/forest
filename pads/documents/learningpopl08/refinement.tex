...
struct using the ``common postfix in union'' rules.  This 
...
string {\tt "-"} in phase three of rewriting.
...
Hence, a switched union is introduced.
...
Note that the switched union is switching on a different enum 

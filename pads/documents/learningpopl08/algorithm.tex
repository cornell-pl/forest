...
Note that several of these histograms have many bars of very small height,
including (f) with 7, (g) with 8, and (k) with 17. 
}\shrink
...
To distinguish between structs, arrays and unions,

...
this paper is closely connected to regular expressions: struct types
correspond to concatenation, array types to Kleene star 
and union types to unions.  Some of the dependencies
...
the number of alternatives grows).  We describe approaches to learning
regular expressions in \secref{sec:related}.

In addition to parsing, there is a more interesting

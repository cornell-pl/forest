...
Overall, it is important to observe that from a parsing perspective,
...
It is also important to understand that each \pads{} type has an additional
interpretation, unrelated to parsing, as a set of data structures.

...
\trversion{We based this behaviour 
directly on the actual \pads{} language.}
...
cascading conditional types~\footnote{We can safely replicate $e$ as the
host language is side-effect free.}

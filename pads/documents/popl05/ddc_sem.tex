...
type corresponding to each \ddc{} type. Most PD types share the
basic shape of a header and a body, which is critical to the
definition of polymorphic functions on PDs. 
%For well-formed types, we
%have proven that all PD types have a header and body.

...
\figref{fig:ddc-sem} shows the parsing semantics function.
For each type,
...
in failure.}
The error count is determined by the error counts of
...
Function $\codefont{isDone}$ determines whether the parser

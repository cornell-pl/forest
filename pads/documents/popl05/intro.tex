...
\figHeight{architecture}{Architecture of \pads{}  system.}{fig:architecture}{2in}

While differing in many details, the broad design and underlying rationale 
for all of these languages are similar. 
\figref{fig:architecture} illustrates their common architecture.
...
\packettypes{'} overlays and devise an implementation strategy

...
\]
  \caption{\ddc{} Normalized Syntax and Reduction Rules}
...
\reminder{This property isn't terribly useful given its limitation to
  syntactic errors. We really want to state that there are no errors,
  but there's no simple way to do that.}

...
correlation with the relation $\corr \tyval r p$. As the encoding of
...
before use. {\it Type normalization} is defined
\figref{fig:revised-ddc-syntax}, with a refactored syntax chart of the
\ddc{} and normalization rules.  For clarity, we define $\corrkl \ty r
p$ as a ``helper'' relation that normalizes types before checking for
correlation.

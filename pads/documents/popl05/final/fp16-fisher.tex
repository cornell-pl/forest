...
\item \packettypes{}: arrays, where clauses, structures, overlays,
  and alternation.
\item \datascript{}: constrained types (enumerations and bitmask sets),
...
G.~O. Consortium.
\newblock Gene ontology project.
\newblock http://www.geneontology.org/.

\bibitem{eger:blt}
D.~Eger.
\newblock Bit level types.
\newblock \url{http://www-2.cs.cmu.edu/~eger/}.
...
\newblock In {\em PLDI}, pages 295--304. {ACM} Press, June 2005.

\bibitem{ford:packrat}
B.~Ford.
\newblock Packrat parsing:: simple, powerful, lazy, linear time.
\newblock In {\em {ACM} International Conference on Functional Programming},
  pages 36--47. {ACM} Press, Oct. 2002.
...
\newblock In {\em {ACM} Symposium on Principles of Programming Languages},
  pages 111--122. {ACM} Press, Jan. 2004.
...
\newblock In {\em European Symposium on Programming}, pages 124--139. Springer,
  Mar. 2004.
...
\newblock Available at \url{http://www-2.cs.cmu.edu/~rwh/}.
...
\newblock In {\em {ACM} Conference on Object-oriented Programming, Systems,
  Languages, and Applications}, pages 132--146. {ACM} Press, 1999.
...
\newblock {\em Communications of the {ACM}}, 9(3):157 -- 166, Mar. 1966.
...
\newblock
  \url{http://workshop.molecularevolution.org/resources/fileformats/tree_forma%
ts.php}.
...
\newblock In {\em Fifth International {Erlang/OTP} User Conference}, Oct. 1999.

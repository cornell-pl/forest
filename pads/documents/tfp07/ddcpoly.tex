...
parameter $e$ is drawn from the host language.  The \padsml{} type
...
the pair can be referenced when describing the second element.
...
description $\ty$ and the predicate $e$. 

...
\trversion{\em Modify a\_pd to a\_pd\_body, everywhere. This name is more
  ...
  interpretations should be done with the type interpretation
...
contains a complete formal specification~\cite{fisher+:popl-sub-long}.
...
generated parsers and printers. We prove the theorem using a more general induction

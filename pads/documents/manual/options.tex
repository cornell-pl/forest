...
\secref{sec:unions-inline}).  For example,  we can rewrite 
\cd{entry1} as follows and produce an equivalent description:
\input{code/simple-inline-opt}

\noindent
Similarly, can rewrite \cd{entry3} to the equivalent description
\cd{entry4} 

...
string literal \cd{"*"} and the regular expression literal \cd{\Pre{}
  "/a+/"}.
\input{code/union.literal}
...
For in-place \Punion{}s with the \Plongest{} qualifier, the reading
code reads the data... \note{finish this description.}

...
integer type.  Predicates that evaluate to \cd{0} imply the data
is valid, while all other values imply the data is
invalid. Predicates are assumed to be side-effect free.
...
without storing any corresponding data in the resulting in-memory
...
\subsection{Example}
The \cd{formalParamExample} in the following \padsl{} fragment
illustrates both declaring parameters to \pads{} types, while
...
\textbf{Bob:? Fill in here.} 


\section{\Pfile{} modifier}
\lable{sec:commong-pfile}

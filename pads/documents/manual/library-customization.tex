...
\begin{description}
\item
[\cd{Pio\_disc\_t * P\_fwrec\_make(size\_t leader\_len, size\_t data\_len, size\_t trailer\_len)}]
...
\item[\cd{Pio\_disc\_t * P\_fwrec\_noseek\_make(size\_t leader\_len, 

...
sources of 5, 10, and 50 MB on Platform~I.  We were particularly interested in the
...
storage system~\cite{galax:ximep2004}, which has a similar
architecture in which the generic data model is in O'Caml and the
secondary storage system is in \C{}. 

...
The \C{} declarations for the in-memory representation (Line~1), the
mask (Line~5), 
...
The parsing functions, \eg{} \cd{event\_t\_read} on Line~8, take a mask as an argument and returns an

...
\cd{fn:doc} function, \eg{} \cd{fn:doc("pads:/example/sirius.data")}.
\begin{figure*}
\begin{small}
\begin{code}
...
\cd{node\_name}, \cd{typed\_value}), this module delegates to the
corresponding type-specific methods.  One exception is the \cd{child}
axis method
\begin{figure*}
\begin{small}
\begin{code}
...
Figure~\ref{fig:padx-element-node}.}


Figure~\ref{fig:padx-node-rep}.

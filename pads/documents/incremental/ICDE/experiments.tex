...
running Linux version 2.6.18 with 46 GBs of memory.
...
HALO\_have2impression.log.1 & 360 MB &  210034 & Server side impression records of iPhone applications\\ \hline
...
a {\em normalized edit distance} measure:
...
The rest of this section presents the results of five sets of experiments.
...
Sources & Time & Time (UC) &  Dist & Dist (UC) \\ \hline \hline
...
Sources & Time & Time (UC) & Score & Score(UC) & Dist & Dist (UC) \\ \hline \hline
...
Table \ref{tab:uceffects}. We set the initial batch size to be 500 and 
incremental batch size to be 100 for all data sources. We can conclude that

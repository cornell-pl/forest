...
For example, suppose the current top-level description \cd{D} when learning 
the \ai{} format is:
\begin{code}
...
parsing. Now, suppose \cd{D} is used to parse the second record 
in \figref{fig:ai}.

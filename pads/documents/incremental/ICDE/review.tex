...
We use a simple web server log format, which we call \ai{}
in \figref{fig:ai}, to illustrate the principal 
features of the \pads{} data
...
While compiled, the generated data structures and parsing code 
are in \C{}.

\figref{fig:ai.p} shows a \padsc{} specification that describes each
of the records in \figref{fig:ai}.  
...
and outputs a candidate description.  In the {\em format refinement} phase,

...
To study and compare \padsc{}, \padsml{}, \datascript{}, and/or
some other data description language, we advocate translating
the language into the \ddc{}.  The translation decomposes
...
\padsc{} language that captures the essence of the actual 
...
In summary, this article makes the following theoretical and practical
contributions:
%
\begin{itemize}
...
version of the \padsc{} programming language
...
there are two important differences.  First, we have found several subtle
ways to improve the structure of the semantics of the
\ddc{}, since we first introduced it in 2006.  In particular,
we have been able to eliminate the ``contractiveness'' constraint
we previously thought was necessary.  This had the effect of allowing us 
to simplify our earlier kinding rules substantially.  Second, we have
...
it explains the proof techniques used to achieve all our formal results
in detail.  Much of the new work, including proofs, are drawn directly from
...
Section~\ref{sec:ddc-encodings} discusses encodings of \ipads{}, \packettypes{}

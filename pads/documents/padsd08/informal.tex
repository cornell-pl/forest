...
to construct compound feeds containing data of different sorts.  For
example, if \cd{sites\_mime} is a feed of XXXs and
\cd{sites\_keyscan\_mime} is a feed of YYYs, then the declaration 
...
\end{code}
%
creates a feed with elements drawn from each of the constituent

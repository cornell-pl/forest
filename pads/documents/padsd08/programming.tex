...
orthogonal to our discussion. First, we use \cd{Feed.split_every} to
...
function. We also sketch an \cd{update_l} function which makes use of 
...
%\end{code} 
where \cd{'a prefeed} is an AST of a feed description and feed 

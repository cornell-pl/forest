...
explain.\footnote{Some of the smarter members of the group have attempted
to explain it multiple times to one of the dumber members (David Walker)
and he still has trouble understanding how it works.}  Avoiding these
...
the \padsml{} infrastructure~\cite{padsml-padl-long} as well as
Yang~\cite{yang:icfp98} and Hinze's work~\cite{hinz:icfp04} on 
...
language extension.  On the latter point, developing one system in which

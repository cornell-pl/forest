...
adding data arrival times and more detailed error information.
...
cost. Also note that the network latency is
...
\pads{}~\cite{fisher+:pads,fisher+:popl06,mandelbaum+:pads-ml-long,fisher+:dirttoshovels} has had success as a language extension on top of C as well as
...
specification and through a uniform notation.  It gives the off-the-shelf
user everything they need in a single language.  Forcing a division 

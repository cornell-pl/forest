...
PlanetLab host              & Archiving every 5 minutes \\
monitoring                              & From evolving set of 800+ nodes \\\hline
CoBlitz~\cite{coblitz}   & Multiple data sets \\
File transfer         & Archiving every 3 minutes \\
system monitoring                                       & From evolving set of 800+ nodes \\\hline
CoralCDN~\cite{coral}         & Single Format \\
Log files from  & Periodic archiving \\
CDN monitoring                  & From evolving set of 250+ hosts \\\hline
AT\&T \vizGems{}                    & Execute programs remotely to \\
 website host                 & collect data \\
 monitoring                   & Varied fetch frequencies \\\hline
AT\&T \darkstar{}                   & Diverse data sources\\
network       & Archiving for future analysis \\
monitoring                              & Per minute, hour, and day fetches\\\hline
AT\&T \ningaui{}                    & Thousands of data sources\\
billing auditing        & Archiving and error analysis\\\hline
GO DB~\cite{geneontology} & Multiple Formats \\
Gene function info.     & Uploads daily, weekly, monthly \\\hline
BioGrid~\cite{biogrid}        & XML and Tab-separated Formats \\
Curated gene and  & multiple data sets $<=$ 50MB each \\
protein data                              & Monthly data releases \\\hline
NCBI~\cite{ncbi} & Links to multiple bioinformatics  \\
Biotechnology info. & datasets\\
\hline\hline
\end{tabular}
\end{center}
...
\padsd{} supports two other {\em modes of use} in addition to off-the-shelf.
...
off-the-shelf, single-minded implementer and generic 

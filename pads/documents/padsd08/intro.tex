...
%\paragraph*{\padsd{}: A specification language for distributed data sources.}
In order to support the creation, maintenance, and evolution of tools
...
language and prove our key correctness properties (\secref{sec:semantics}), 

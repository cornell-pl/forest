...
The surface language ``\kw{foreach} $x$ in $\feed_1$ \kw{create} $\feed_2$'' 
can be translated to the abstract syntax as 
$\comprehensionfeed{\feed_2}{x}{\feed_1}$. 
The feed $\filterfeed{\feed}{e}$ eliminates elements $v$ from $\feed$ when
$e\; v$ is $\boolf$.  
The alternate feed comprehension
syntax in Section \ref{sec:vizgems}, 
$\comprehensionfeed{e_2}{x}{\feed_1,~ e_1}$, can be modeled as
$\comprehensionfeed{\onefeed{e_2}{x.1.t}}{x}{\filterfeed{\feed_1}{e_1}}$. 
Let feeds $\letfeed{x}{e}{\feed}$
...
\noindent
We have proven this theorem by induction on the structure of feeds.  

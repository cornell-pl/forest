...
\begin{array}{lcl}
 ...
 &=& (S, \{((\atime,\{(\atime,\loc)\}, (\atime,\loc,\mathtt{arrival}(\atime,\universe(\atime,\loc))), \esemantics{e_f\; (\universe'(\loc,\atime))}{\environment}))
          \setalt \atime \in S
...
\semantics{[\feed \bnfalt x \leftarrow e]}{\environment}{\universe} 
 &=&
 \{((\atime,\bigcup_{i=1..k} \myds{\meta_i}, [\myval{\meta_1},\ldots,\myval{\meta_k}]),[v_1,\ldots,v_k]) \setalt 
\\ && \quad
...
\semantics{\comprehensionfeed{\feed_2}{x}{\feed_1}}{\environment}{\universe} 
 &=& \{((\mytime{\meta_2},\myds{\meta_1} \cup \myds{\meta_2}, \myval{\meta_2}),v_2) 
          ...
          (\meta_2,v_2) \in \semantics{\feed_2}{(\environment,x\mapsto(\meta,v_1))}{\universe}  
     \} 
\\\\

...
\vskip -.1in
\caption{Anonymized snippet of Princeton computer science undergraduate data. The red
...
As it has evolved over time, there 
have been a few slight changes in format -- typical for
ad hoc \filestores{}.  Naturally, any description needs to cope
with the variation.
...
with a top-level \cd{logs} directory containing a set of subdirectories, one

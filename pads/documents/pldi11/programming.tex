...
\dpw{replaced unsafeIO with monadic style}
As a simple example, consider the \cd{Coral} description from
...
\end{code}
% $
\jnf{do we want to show output? we'll have to be careful to
  sanitize the data.}
\dpw{no space for output}

...
\trans[\pmu \ptyvar \gk \ty,,] = \\
  ...
  \qquad \ictup{\off',\iroll{r}{\pmu \ptyvar \gk \itsem[\ty]},(p.h,\iroll{p}{\pmu \ptyvar \kty \itpdsem[\ty]})}
%}}
  \end{array}  
\\[3pt]
%% Compute
...
%%       }
    ...
    \psum \ty e \ty  \| \pand \ty \ty \|
    \pset x \ty e  \|
    \pseq \ty \ty {\pterm e \ty} \| \pmu{\ptyvar}{\ty} \nlalt
...
%     $\corrkl {\ty'[\pmu \ptyvar {\ty'}/\ptyvar]} r p$.
  \item $\tyval = \mu \alpha.\tau$, 
        and $r = \iroll{r'}{\pmu \ptyvar \gk \itsem[\ty]}$, \\
        and $p = (h,\iroll{h,p'}{\pmu \ptyvar \gk \itpdsem[\ty]})$ \\
        and  $\corrkl {\tau[\mu \alpha.\tau/\alpha]} {r'} {(h,p')}$

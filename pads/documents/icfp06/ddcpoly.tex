...
The base types of \ddc{} include $\ptrue$ and $\pfalse$, describing
...
unusual features. The complete syntax can be found in \appref{???}.
...
construct parsers, etc. Formally, \figref{fig:parser-types} specifies

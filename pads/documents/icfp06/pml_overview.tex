...
the \kw{Parray} type constructor in \pads{}), which are critical in
...
components. For example, the \cd{Plist} type that appears in both the
...
boolean expression.  Data \cd{d} satisfies this description if it

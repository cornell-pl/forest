...
\cd{Events} indicates that this part of the \dibbler{} data 
contains a sequence of \cd{Event}s separated by vertical bars and
...
problem with a network link; sample data appears in \figref{fig:darkstar-records1}.
...
definition of \cd{Pnvp}, we take advantage of both type
...
data. 
\cut{We can do this because we can discern from the datatype constructor

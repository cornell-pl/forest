...
\itpdsem[\pscan{\ty}] & = & \ipty {(\isum {(\iprod \iintty
  {\iprod \ibitsty {\itpdsem[\ty]}})} \iunitty)}
% \itpdsem[\pscan{\ty}] & = & \ipty {(\iprod \iintty
%   {\iprod \ibitsty {(\isum {
%     {\itpdsem[\ty]}} \iunitty)}})}
\end{array}
\]
...
\trans[\pmu \ptyvar \gk \ty,,] = \\
  ...
  \quad \ilet {\itup{\off',r,p}} 
   {\trans[\ty,,][\itsem[\pmu \ptyvar \gk \ty]/\ptyvar_\repname]
          [\itpdsem[\pmu \ptyvar \gk \ty]/\ptyvar_\pdbname] \iappi \ictup{\data,\off}} \\ 
  \qquad \ictup{\off',\iroll{r}{\itsem[\pmu \ptyvar \gk \ty]},
     (p.h,\iroll{p}{\itpdsem[\pmu \ptyvar \gk \ty]})}
%}}
  \end{array}  
\\[3pt]
%% lambda \alpha
...
\trans[\pscan \ty,,] = \\
  \begin{array}{l}  
    ...
    \quad \iletfun {try} {i} {\\
      ...
      \qquad {\ictup{\off',\newrep {scan} r,
        \newpd {scan} {i,\subbits \idata \off {i+1},p}}}\; \ielse {}\\
      \qquad \iif {\eofpred {\idata,\off + i}}\; \ithen \\
      \qquad {\ictup{\off,\newrep {scan\_err} {},
...
\item $\ifun{P_{scan}} {\itup{i,\idata,p}} {}$ \\
$\begin{array}{l}
...
\quad \ictup{hdr,\iinl {\ictup{i,\idata,p}}}
\end{array}$
...
\transpp[\psig{x}{\ty_1}{\ty_2},\ctxt,\kty] = \\
  \begin{array}{l}  
    \lampppair{} \\
      \quad  \ilet x {\ictup{\ipid{1}{r},\ipid{1}{\ipid{\ipbdy}{pd}}}}\\
      \quad  \ilet {bs_1} 
%%    \def \rf {foo} %% {\ipid{1}{r}}
%%   \def \pf {bar} %% {\ipid{1}{\ipid{\ipbdy}{pd}}}
%%  \def \rs {baz} %% {\ipid{2}{r}}
%% \def \ps {foo} %% {\ipid{2}{\ipid{\ipbdy}{pd}}}
      {{\transpp[\ty_1,,]} \sapp \codefont{x}} \\
      \quad  \ilet {bs_2} 
      {{\transpp[\ty_2,,]} \sapp \spair<\ipid{2}{r},\ipid{2}{\ipid{\ipbdy}{pd}}>} \\
...
%\begin{array}{l}
  ...
  \begin{array}{l}  
  \lampppair{} \\
  \quad \icasess {\ictup{r,\ipid{\ipbdy}{pd}}} \\
...
%% Intersection 
  ...
  \begin{array}{l}  
    \lampppair{} \\
    \quad \ilet {p_1}{\ipid {1} {\ipid {\ipbdy}{pd}}} \\
    \quad \ilet {p_2}{\ipid {2} {\ipid {\ipbdy}{pd}}} \\
    \quad \iif {\ipid {end} {\ipid {sp} {\ipid h {p_1}}} > \ipid {end} {\ipid {sp}
          {\ipid h {p_2}}}} \\
    \qquad \ithen {{\transpp[\ty_1,,]} \sapp \ictup{\ipid{1}{r},p_1}} \\
    \qquad  \ielse{{\transpp[\ty_2,,]} \sapp \ictup{\ipid{2}{r},p_2}}
   \end{array}
\\
%\quad
%% Set 
  ...
  \begin{array}{l}  
  \lampppair{} \\
  \quad \icasess {\codefont{r}} \\
  \quad \ipattss{\iinl{r_1}} 
	{ {\transpp[\ty,,]} \sapp \codefont{\ictup{r_1,\ipid{\ipbdy}{pd}}}}\\
  \quad \ipattss{\iinr{r_2}} 
	{ {\transpp[\ty,,]} \sapp \codefont{\ictup{r_2,\ipid{\ipbdy}{pd}}}}\\
  \end{array}
\\
\end{array}
\begin{array}{l}
...
\transpp[\pmu \ptyvar \gk \ty,,] = \\
  ...
  \ifun {\printname_\ptyvar} {\itup{r:\pmu \ptyvar \gk \itsem[\ty], pd:\ipty{\pmu \ptyvar \kty \itpdsem[\ty]}}
                     : \ibitsty} {}\\
  \quad \transpp[\ty,,] \ictup{\iunroll{r}{\pmu \ptyvar \gk \itsem[\ty]},
     \iunroll{pd.\ipbdy}{\pmu \ptyvar \kty \itpdsem[\ty]}}
%}}
  \end{array}  
\\[3pt]
%% lambda \alpha
...
%  \begin{array}{l}  
%     {\transpp[\ty,,]} \sapp \codefont{\ictup{\ipid{1}{\ipid{\ipbdy}{p}},
% 		                                   \ipid{2}{\ipid{\ipbdy}{p}}}} \\
% \end{array}  
\\
%% Scan
\transpp[\pscan \ty,,] = \\
  \begin{array}{l}  
    ...
    \quad \icasess {\ictup{r,\ipid{\ipbdy}{pd}}} \\
    \quad \ipattss{\ictup{\iinl{r_1}, \iinl{p_1}}} 
	{ \ipid {skipped} {p_1} \; \codefont{@} \; {\transpp[\ty,,]} \sapp \codefont{\ictup{r_1,\ipid 3 {p_1}}}}\\
...
% function pp_a (r, pd) = 
%  [[t]]_pp (unfold r,unfold (pd.\ipbdy))
%

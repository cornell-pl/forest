...
We used this new semantics to guide the \padsml{} implementation of printing.  \secref{sec:ddc} presents the extended \ddc{} calculus, focusing on the semantics of polymorphic types for parsing and the key elements of the printing semantics.  
\cut{We show that both parsers and printers in the \ddc{} are type correct and furthermore that printers produce pairs of parsed data and parse descriptors in {\em canonical form}.  }
...
polymorphic, dependent and recursive datatypes.  This design
...
as well as auxiliary support for user-specified format-dependent
and format-independent tool generation.
...
well-behaved as defined by an important canonical forms theorem.
\end{itemize}

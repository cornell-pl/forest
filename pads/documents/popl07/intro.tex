...
(a) Simplified Regulus network-monitoring data. The `$\backslash$' denotes a newline we inserted to improve readability. 
...
(c) Newick data used to study immune system responses. 
  ...
  \caption{Snippets of a variety of ad hoc data formats.}
...
First of all, the description itself
...
data processing tools and programming libraries specialized

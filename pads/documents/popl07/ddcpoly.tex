...
relation, $\corr \tyval r p$ (see Canonical Forms I below),
...
A second definition, $\corrkl \ty r p$ (see Canonical Forms II below),
...
\]
  \caption{\ddc{} Normal Types and Normalization}
  \label{fig:ddc-reduction-rules}
  \label{fig:revised-ddc-syntax}
\end{figure}

\begin{definition}[Canonical Forms I (selected constructs)]
...
\begin{lemma}[Parsing to/Printing from Canonical Forms]

...
limited to conversion to-and-from \xml{};  neither is of any use for analysts who do not wish to convert their data to \xml{}. \padsml{} is thus broader in scope: it \textit{can} convert data into \xml{}, but it can do many other tasks as well.  

...
In contrast, algebraic specification languages \textit{do} capture both the concrete syntax of a language and other properties, yet  target a very different domain than data description.
Our new
...
data structures that are generated in a manner appropriate to data
formats.  
...
From a semantic perspective, algebraic specification languages are
closer to \ddc{} than other parser generator languages. We briefly
discuss one such formalism: the Syntax Defintion Formalism
...
Yet, for all of SDF2's power and overlap with \ddc{} features, it
...
underlying host language, and an explicit accounting of the
error-handling features of generated parsers.

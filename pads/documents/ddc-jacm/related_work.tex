...
In contrast, there exist formalisms for specifying programming languages as algebras, in which a single language specification captures both the concrete and abstract syntax of the language being specified.
Yet, these systems target programming languages (and the like), not data formats.
Our new
...
data structures that are generated, and in a manner appropriate to data
formats.  

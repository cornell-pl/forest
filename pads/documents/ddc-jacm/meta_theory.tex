...
critical properties hold for our \ddc\ theory. We do so only briefly, however, bringing out the essential elements of the metatheory.  An extended treatment of this material can be found in \appref{app:ddc-meta-theory}. First, we require that \ddc{} base types satisfy the properties that we
...
The following result, while serving as a lemma for other results, also has inherent value for reasoning about \ddc{}. In essence, it says that evaluation (aka. normalization,

...
\icmlauthor{David Burke and Peter White}{\{davidb,peter\}@galois.com}
\icmladdress{Galois Connections, Inc, Portland, OR}
\icmlauthor{Kathleen Fisher}{kfisher@research.att.com}
\icmladdress{AT\&T Labs}
\icmlauthor{David Walker and Kenny Q. Zhu}{\{dpw,kzhu\}@cs.princeton.edu}

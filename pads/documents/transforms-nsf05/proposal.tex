...
\figHeight{architecture}{The \datatype{} System}{fig:dsys}{4in}
...
\subsubsection{The \datatype{} Language Infrastructure}
...
ML-like syntax.  Finally, \kw{Ptypedef}s can be used to
...
\figref{figure:dibbler} gives a \datatype{} description for the \dibbler{} 

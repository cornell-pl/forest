...
of types should flip forward to \figref{figure:syntax-dd}.
...
\cd{T} and boolean \cd{M} with the \pvalue{} \cd{d} substituted for \cd{x}
...
abstract.  Later in the description, \cd{nvp}'s
are used with ip addresses, timestamps and integers. In the \cd{nvp\_a} 
...
\cd{5075}, the format specification given by the 

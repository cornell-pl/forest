...
\cut{\pads{} provides several data-analysis tools
...
at run time or at compile time.
 ...
 and intrinsic mechanisms for checking data invariants
at run time}
...
\cut{\datatype{} makes it possible to write accurate, complete, and

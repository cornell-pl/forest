...
ssize_t Pbcd_int16_write2io (P_t *pads, Sfio_t *io, Pbase_pd *pd,
			     Pint16  *val, Puint32 num_digits);
ssize_t Pbcd_int32_write2io (P_t *pads, Sfio_t *io, Pbase_pd *pd,
			     Pint32  *val, Puint32 num_digits);
ssize_t Pbcd_int64_write2io (P_t *pads, Sfio_t *io, Pbase_pd *pd,
			     Pint64  *val, Puint32 num_digits);
						  			                          
ssize_t Pbcd_uint8_write2io (P_t *pads, Sfio_t *io, Pbase_pd *pd,
			     Puint8  *val, Puint32 num_digits);
ssize_t Pbcd_uint16_write2io(P_t *pads, Sfio_t *io, Pbase_pd *pd,
			     Puint16 *val, Puint32 num_digits);
ssize_t Pbcd_uint32_write2io(P_t *pads, Sfio_t *io, Pbase_pd *pd,
...
ssize_t Pbcd_int8_write_xml_2io  (P_t *pads, Sfio_t *io, Pbase_pd *pd,
				  ...
				  Puint32 num_digits);
ssize_t Pbcd_int16_write_xml_2io (P_t *pads, Sfio_t *io, Pbase_pd *pd,
				  Pint16  *val, const char *tag, int indent,
				  Puint32 num_digits);
ssize_t Pbcd_int32_write_xml_2io (P_t *pads, Sfio_t *io, Pbase_pd *pd,
				  Pint32  *val, const char *tag, int indent,
				  Puint32 num_digits);
ssize_t Pbcd_int64_write_xml_2io (P_t *pads, Sfio_t *io, Pbase_pd *pd,
				  Pint64  *val, const char *tag, int indent,
				  Puint32 num_digits);
						       								                    
ssize_t Pbcd_uint8_write_xml_2io (P_t *pads, Sfio_t *io, Pbase_pd *pd,
				  Puint8  *val, const char *tag, int indent,
				  Puint32 num_digits);
ssize_t Pbcd_uint16_write_xml_2io(P_t *pads, Sfio_t *io, Pbase_pd *pd,
				  Puint16 *val, const char *tag, int indent,
				  Puint32 num_digits);
ssize_t Pbcd_uint32_write_xml_2io(P_t *pads, Sfio_t *io, Pbase_pd *pd,
				  Puint32 *val, const char *tag, int indent,
				  Puint32 num_digits);

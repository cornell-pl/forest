...
#define PDCI_DECL_BASE_VT(ty) extern const PDCI_vtable_t ty ## _vtable
...
PDCI_DECL_BASE_VT(PDCI_structured_pd_vtable);
PDCI_DECL_BASE_VT(PDCI_sequenced_pd_vtable);
PDCI_DECL_BASE_VT(PDCI_basetype_vtable);

PDCI_DECL_BASE_VT(PDC_base_pd_vtable);
PDCI_DECL_BASE_VT(PDC_errCode_t_vtable);
PDCI_DECL_BASE_VT(PDC_loc_t_vtable);
PDCI_DECL_BASE_VT(PDC_pos_t_vtable);
...
PDCI_DECL_BASE_VT(PDC_char_vtable);
PDCI_DECL_BASE_VT(PDC_a_char_vtable);
PDCI_DECL_BASE_VT(PDC_e_char_vtable);

PDCI_DECL_BASE_VT(PDC_string_vtable);
PDCI_DECL_BASE_VT(PDC_string_ME_vtable);
PDCI_DECL_BASE_VT(PDC_string_CME_vtable);
PDCI_DECL_BASE_VT(PDC_string_SE_vtable);
PDCI_DECL_BASE_VT(PDC_string_CSE_vtable);

PDCI_DECL_BASE_VT(PDC_a_string_vtable);
PDCI_DECL_BASE_VT(PDC_a_string_ME_vtable);
PDCI_DECL_BASE_VT(PDC_a_string_CME_vtable);
PDCI_DECL_BASE_VT(PDC_a_string_SE_vtable);
PDCI_DECL_BASE_VT(PDC_a_string_CSE_vtable);

PDCI_DECL_BASE_VT(PDC_e_string_vtable);
PDCI_DECL_BASE_VT(PDC_e_string_ME_vtable);
PDCI_DECL_BASE_VT(PDC_e_string_CME_vtable);
PDCI_DECL_BASE_VT(PDC_e_string_SE_vtable);
PDCI_DECL_BASE_VT(PDC_e_string_CSE_vtable);

PDCI_DECL_BASE_VT(PDC_date_vtable);
PDCI_DECL_BASE_VT(PDC_a_date_vtable);
PDCI_DECL_BASE_VT(PDC_e_date_vtable);

PDCI_DECL_BASE_VT(PDC_int8_vtable);
PDCI_DECL_BASE_VT(PDC_int16_vtable);
PDCI_DECL_BASE_VT(PDC_int32_vtable);
PDCI_DECL_BASE_VT(PDC_int64_vtable);
PDCI_DECL_BASE_VT(PDC_uint8_vtable);
PDCI_DECL_BASE_VT(PDC_uint16_vtable);
PDCI_DECL_BASE_VT(PDC_uint32_vtable);
PDCI_DECL_BASE_VT(PDC_uint64_vtable);
...
PDCI_DECL_BASE_VT(PDC_char_val_vtable);
PDCI_DECL_BASE_VT(PDC_string_val_vtable);
PDCI_DECL_BASE_VT(PDC_date_val_vtable);
PDCI_DECL_BASE_VT(PDC_int8_val_vtable);
PDCI_DECL_BASE_VT(PDC_int16_val_vtable);
PDCI_DECL_BASE_VT(PDC_int32_val_vtable);
PDCI_DECL_BASE_VT(PDC_int64_val_vtable);
PDCI_DECL_BASE_VT(PDC_uint8_val_vtable);
PDCI_DECL_BASE_VT(PDC_uint16_val_vtable);
PDCI_DECL_BASE_VT(PDC_uint32_val_vtable);
PDCI_DECL_BASE_VT(PDC_uint64_val_vtable);

/* The cases where we can use vtable sharing */
#ifdef FOR_CKIT
PDCI_DECL_BASE_VT(PDC_a_char_val_vtable);
PDCI_DECL_BASE_VT(PDC_e_char_val_vtable);

PDCI_DECL_BASE_VT(PDC_string_ME_val_vtable);
PDCI_DECL_BASE_VT(PDC_string_CME_val_vtable);
PDCI_DECL_BASE_VT(PDC_string_SE_val_vtable);
PDCI_DECL_BASE_VT(PDC_string_CSE_val_vtable);

PDCI_DECL_BASE_VT(PDC_a_string_val_vtable);
PDCI_DECL_BASE_VT(PDC_a_string_ME_val_vtable);
PDCI_DECL_BASE_VT(PDC_a_string_CME_val_vtable);
PDCI_DECL_BASE_VT(PDC_a_string_SE_val_vtable);
PDCI_DECL_BASE_VT(PDC_a_string_CSE_val_vtable);

PDCI_DECL_BASE_VT(PDC_e_string_val_vtable);
PDCI_DECL_BASE_VT(PDC_e_string_ME_val_vtable);
PDCI_DECL_BASE_VT(PDC_e_string_CME_val_vtable);
PDCI_DECL_BASE_VT(PDC_e_string_SE_val_vtable);
PDCI_DECL_BASE_VT(PDC_e_string_CSE_val_vtable);

PDCI_DECL_BASE_VT(PDC_a_date_val_vtable);
PDCI_DECL_BASE_VT(PDC_e_date_val_vtable);
...
PDCI_DECL_BASE_MK(PDC_char_vtable);
PDCI_DECL_BASE_MK(PDC_a_char_vtable);
PDCI_DECL_BASE_MK(PDC_e_char_vtable);

PDCI_DECL_BASE_MK(PDC_string_vtable);
PDCI_DECL_BASE_MK(PDC_string_ME_vtable);
PDCI_DECL_BASE_MK(PDC_string_CME_vtable);
PDCI_DECL_BASE_MK(PDC_string_SE_vtable);
PDCI_DECL_BASE_MK(PDC_string_CSE_vtable);

PDCI_DECL_BASE_MK(PDC_a_string_vtable);
PDCI_DECL_BASE_MK(PDC_a_string_ME_vtable);
PDCI_DECL_BASE_MK(PDC_a_string_CME_vtable);
PDCI_DECL_BASE_MK(PDC_a_string_SE_vtable);
PDCI_DECL_BASE_MK(PDC_a_string_CSE_vtable);

PDCI_DECL_BASE_MK(PDC_e_string_vtable);
PDCI_DECL_BASE_MK(PDC_e_string_ME_vtable);
PDCI_DECL_BASE_MK(PDC_e_string_CME_vtable);
PDCI_DECL_BASE_MK(PDC_e_string_SE_vtable);
PDCI_DECL_BASE_MK(PDC_e_string_CSE_vtable);

PDCI_DECL_BASE_MK(PDC_date_vtable);
PDCI_DECL_BASE_MK(PDC_a_date_vtable);
PDCI_DECL_BASE_MK(PDC_e_date_vtable);

PDCI_DECL_BASE_MK(PDC_int8_vtable);
PDCI_DECL_BASE_MK(PDC_int16_vtable);
PDCI_DECL_BASE_MK(PDC_int32_vtable);
PDCI_DECL_BASE_MK(PDC_int64_vtable);
PDCI_DECL_BASE_MK(PDC_uint8_vtable);
PDCI_DECL_BASE_MK(PDC_uint16_vtable);
PDCI_DECL_BASE_MK(PDC_uint32_vtable);
PDCI_DECL_BASE_MK(PDC_uint64_vtable);

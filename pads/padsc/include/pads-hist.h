...
typedef struct P_hist_s {
  ...
  char           *prefix;        // Help print name.
  char           *what;          // Help print type.
  int            nst;            // Help print separator format.
...
Perror_t Pint8_hist_map_report2io  (P_t *pads, Sfio_t *outstr, const char *prefix, const char *what, int nst, Pint8_map_fn fn, Pint8_hist *h);
...
Perror_t Pint16_hist_map_report2io (P_t *pads, Sfio_t *outstr, const char *prefix, const char *what, int nst, Pint16_map_fn fn, Pint16_hist *h);
...
Perror_t Pint32_hist_map_report2io (P_t *pads, Sfio_t *outstr, const char *prefix, const char *what, int nst, Pint32_map_fn fn, Pint32_hist *h);
...
Perror_t Pint64_hist_map_report2io (P_t *pads, Sfio_t *outstr, const char *prefix, const char *what, int nst, Pint64_map_fn fn, Pint64_hist *h);
...
Perror_t Puint8_hist_map_report2io (P_t *pads, Sfio_t *outstr, const char *prefix, const char *what, int nst, Puint8_map_fn fn, Puint8_hist *h);
...
Perror_t Puint16_hist_map_report2io(P_t *pads, Sfio_t *outstr, const char *prefix, const char *what, int nst, Puint16_map_fn fn, Puint16_hist *h);
...
Perror_t Puint32_hist_map_report2io  (P_t *pads, Sfio_t *outstr, const char *prefix, const char *what, int nst, Puint32_map_fn fn, Puint32_hist *h);
...
Perror_t Puint64_hist_map_report2io    (P_t *pads, Sfio_t *outstr, const char *prefix, const char *what, int nst, Puint64_map_fn fn, Puint64_hist *h);
...
Perror_t Pint16_report      (Sfio_t *outstr, Pint16_hist *h);
Perror_t Pint32_report      (Sfio_t *outstr, Pint32_hist *h);
Perror_t Pint64_report      (Sfio_t *outstr, Pint64_hist *h);
Perror_t Puint8_report      (Sfio_t *outstr, Puint8_hist *h);
Perror_t Puint16_report     (Sfio_t *outstr, Puint16_hist *h);
Perror_t Puint32_report     (Sfio_t *outstr, Puint32_hist *h);
Perror_t Puint64_report     (Sfio_t *outstr, Puint64_hist *h);
Perror_t Pint8_map_report   (Sfio_t *outstr, Pint8_map_fn fn, Pint8_hist *h);
Perror_t Pint16_map_report  (Sfio_t *outstr, Pint16_map_fn fn, Pint16_hist *h);
Perror_t Pint32_map_report  (Sfio_t *outstr, Pint32_map_fn fn, Pint32_hist *h);
Perror_t Pint64_map_report  (Sfio_t *outstr, Pint64_map_fn fn, Pint64_hist *h);
Perror_t Puint8_map_report  (Sfio_t *outstr, Puint8_map_fn fn, Puint8_hist *h);
Perror_t Puint16_map_report (Sfio_t *outstr, Puint16_map_fn fn, Puint16_hist *h);
Perror_t Puint32_map_report (Sfio_t *outstr, Puint32_map_fn fn, Puint32_hist *h);
Perror_t Puint64_map_report (Sfio_t *outstr, Puint64_map_fn fn, Puint64_hist *h);
Perror_t Pfloat32_report    (Sfio_t *outstr, Pfloat32_hist *h);
Perror_t Pfloat64_report    (Sfio_t *outstr, Pfloat64_hist *h);
Perror_t Pchar_report       (Sfio_t *outstr, Pchar_hist *h);
Perror_t Pstring_report     (Sfio_t *outstr, Pstring_hist *h);
Perror_t Pip_report         (Sfio_t *outstr, Pip_hist *h);
Perror_t Ptimestamp_report  (Sfio_t *outstr, Ptimestamp_hist *h);
Perror_t Ptime_report       (Sfio_t *outstr, Ptime_hist *h);
Perror_t Pdate_report       (Sfio_t *outstr, Pdate_hist *h);

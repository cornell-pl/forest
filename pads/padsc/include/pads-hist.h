...
typedef Perror_t (*Pfpoint8_toFloat_fn)     (Pfpoint8*, Pfloat64*);
typedef Perror_t (*Pfpoint8_fromFloat_fn)   (Pfloat64, Pfpoint8*);
typedef Perror_t (*Pfpoint16_toFloat_fn)    (Pfpoint16*, Pfloat64*);
typedef Perror_t (*Pfpoint16_fromFloat_fn)  (Pfloat64, Pfpoint16*);
typedef Perror_t (*Pfpoint32_toFloat_fn)    (Pfpoint32*, Pfloat64*);
typedef Perror_t (*Pfpoint32_fromFloat_fn)  (Pfloat64, Pfpoint32*);
typedef Perror_t (*Pfpoint64_toFloat_fn)    (Pfpoint64*, Pfloat64*);
typedef Perror_t (*Pfpoint64_fromFloat_fn)  (Pfloat64, Pfpoint64*);
typedef Perror_t (*Pufpoint8_toFloat_fn)    (Pufpoint8*, Pfloat64*);
typedef Perror_t (*Pufpoint8_fromFloat_fn)  (Pfloat64, Pufpoint8*);
typedef Perror_t (*Pufpoint16_toFloat_fn)   (Pufpoint16*, Pfloat64*);
typedef Perror_t (*Pufpoint16_fromFloat_fn) (Pfloat64, Pufpoint16*);
typedef Perror_t (*Pufpoint32_toFloat_fn)   (Pufpoint32*, Pfloat64*);
typedef Perror_t (*Pufpoint32_fromFloat_fn) (Pfloat64, Pufpoint32*);
typedef Perror_t (*Pufpoint64_toFloat_fn)   (Pufpoint64*, Pfloat64*);
typedef Perror_t (*Pufpoint64_fromFloat_fn) (Pfloat64, Pufpoint64*);
...
typedef struct P_hist_s {
  ...
  Pint64        portion;        // Index of current portion.
...
Perror_t Pfpoint8_report   (Sfio_t *outstr, Pfpoint8_hist *h);
Perror_t Pfpoint16_report  (Sfio_t *outstr, Pfpoint16_hist *h);
Perror_t Pfpoint32_report  (Sfio_t *outstr, Pfpoint32_hist *h);
Perror_t Pfpoint64_report  (Sfio_t *outstr, Pfpoint64_hist *h);
Perror_t Pufpoint8_report  (Sfio_t *outstr, Pufpoint8_hist *h);
Perror_t Pufpoint16_report (Sfio_t *outstr, Pufpoint16_hist *h);
Perror_t Pufpoint32_report (Sfio_t *outstr, Pufpoint32_hist *h);
Perror_t Pufpoint64_report (Sfio_t *outstr, Pufpoint64_hist *h);

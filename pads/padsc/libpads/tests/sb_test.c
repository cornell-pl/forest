...
int main(int argc, char** argv) {
  ...
  if (PDC_OK == PDC_sbl_int8_read(pdc, &m, 1, &pd, &i8)) {
  ...
  if (PDC_OK == PDC_sbl_uint8_read(pdc, &m, 1, &pd, &u8)) {
  ...
  if (PDC_OK == PDC_sbl_int16_read(pdc, &m, 2, &pd, &i16)) {
  ...
  if (PDC_OK == PDC_sbl_uint16_read(pdc, &m, 2, &pd, &u16)) {
  ...
  if (PDC_OK == PDC_sbl_int32_read(pdc, &m, 4, &pd, &i32)) {
  ...
  if (PDC_OK == PDC_sbl_uint32_read(pdc, &m, 4, &pd, &u32)) {
  ...
  if (PDC_OK == PDC_sbl_int64_read(pdc, &m, 8, &pd, &i64)) {
  ...
  if (PDC_OK == PDC_sbl_uint64_read(pdc, &m, 8, &pd, &u64)) {
  ...
  if (PDC_OK == PDC_sbh_int8_read(pdc, &m, 1, &pd, &i8)) {
  ...
  if (PDC_OK == PDC_sbh_uint8_read(pdc, &m, 1, &pd, &u8)) {
  ...
  if (PDC_OK == PDC_sbh_int16_read(pdc, &m, 2, &pd, &i16)) {
  ...
  if (PDC_OK == PDC_sbh_uint16_read(pdc, &m, 2, &pd, &u16)) {
  ...
  if (PDC_OK == PDC_sbh_int32_read(pdc, &m, 4, &pd, &i32)) {
  ...
  if (PDC_OK == PDC_sbh_uint32_read(pdc, &m, 4, &pd, &u32)) {
  ...
  if (PDC_OK == PDC_sbh_int64_read(pdc, &m, 8, &pd, &i64)) {
  ...
  if (PDC_OK == PDC_sbh_uint64_read(pdc, &m, 8, &pd, &u64)) {

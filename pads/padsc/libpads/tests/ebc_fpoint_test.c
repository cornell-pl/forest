...
int main(int argc, char** argv) {
  ...
  if (PDC_OK == PDC_ebc_fpoint8_read(pdc, &m, 3, 4, &ed, &f8) || ed.errCode != PDC_BAD_PARAM) {
    error(0, "XXX failure: did not get expected BAD_PARAM error XXX");
    return -1;
  }
  NEXT_REC;

  if (PDC_OK == PDC_ebc_fpoint8_read(pdc, &m, 3, 0, &ed, &f8)) {
  ...
  if (PDC_OK == PDC_ebc_fpoint8_read(pdc, &m, 0, 1, &ed, &f8) || ed.errCode != PDC_BAD_PARAM) {
    error(0, "XXX failure: did not get expected BAD_PARAM error XXX");
    return -1;
  }
  NEXT_REC;

  if (PDC_OK == PDC_ebc_fpoint8_read(pdc, &m, 3, 1, &ed, &f8)) {
    error(0, "Read ebc fpoint: num %ld denom %lu", (long)f8.num, (unsigned long)f8.denom);
  ...
  if (PDC_OK == PDC_ebc_fpoint8_read(pdc, &m, 3, 2, &ed, &f8) || ed.errCode != PDC_RANGE) {
    error(0, "XXX failure: did not get expected RANGE error XXX");
    return -1;
  }
  NEXT_REC;

  if (PDC_OK == PDC_ebc_fpoint8_read(pdc, &m, 3, 2, &ed, &f8)) {
    error(0, "Read ebc fpoint: num %ld denom %lu", (long)f8.num, (unsigned long)f8.denom);
  ...
  if (PDC_OK == PDC_ebc_ufpoint8_read(pdc, &m, 3, 2, &ed, &uf8) || ed.errCode != PDC_RANGE) {
    error(0, "XXX failure: did not get expected RANGE error XXX");
    return -1;
  }
  NEXT_REC;

  if (PDC_OK == PDC_ebc_ufpoint8_read(pdc, &m, 3, 2, &ed, &uf8)) {
  ...
  if (PDC_OK == PDC_ebc_fpoint16_read(pdc, &m, 5, 5, &ed, &f16) || ed.errCode != PDC_BAD_PARAM) {
    error(0, "XXX failure: did not get expected BAD_PARAM error XXX");
    return -1;
  }
  NEXT_REC;

  if (PDC_OK == PDC_ebc_fpoint16_read(pdc, &m, 5, 4, &ed, &f16)) {
  ...
  if (PDC_OK == PDC_ebc_fpoint16_read(pdc, &m, 10, 2, &ed, &f16) || ed.errCode != PDC_BAD_PARAM) {
    error(0, "XXX failure: did not get expected BAD_PARAM error XXX");
    return -1;
  }
  NEXT_REC;
  ...
  if (PDC_OK == PDC_ebc_ufpoint16_read(pdc, &m, 5, 4, &ed, &uf16) || ed.errCode != PDC_RANGE) {
    error(0, "XXX failure: did not get expected RANGE error XXX");
    return -1;
  }
  NEXT_REC;

  if (PDC_OK == PDC_ebc_ufpoint16_read(pdc, &m, 5, 4, &ed, &uf16)) {
  ...
  if (PDC_OK == PDC_ebc_fpoint32_read(pdc, &m, 11, 9, &ed, &f32) || ed.errCode != PDC_BAD_PARAM) {
    error(0, "XXX failure: did not get expected BAD_PARAM error XXX");
    return -1;
  }
  NEXT_REC;

  if (PDC_OK == PDC_ebc_fpoint32_read(pdc, &m, 10, 9, &ed, &f32)) {
  ...
  if (PDC_OK == PDC_ebc_fpoint32_read(pdc, &m, 10, 29, &ed, &f32) || ed.errCode != PDC_BAD_PARAM) {
    error(0, "XXX failure: did not get expected BAD_PARAM error XXX");
    return -1;
  }
  NEXT_REC;
  ...
  if (PDC_OK == PDC_ebc_ufpoint32_read(pdc, &m, 11, 9, &ed, &uf32) || ed.errCode != PDC_BAD_PARAM) {
    error(0, "XXX failure: did not get expected BAD_PARAM error XXX");
    return -1;
  }
  NEXT_REC;

  if (PDC_OK == PDC_ebc_ufpoint32_read(pdc, &m, 10, 9, &ed, &uf32)) {
  ...
  if (PDC_OK == PDC_ebc_fpoint64_read(pdc, &m, 19, 19, &ed, &f64) || ed.errCode != PDC_RANGE) {
    error(0, "XXX failure: did not get expected RANGE error XXX");
    return -1;
  }
  NEXT_REC;

  if (PDC_OK == PDC_ebc_fpoint64_read(pdc, &m, 19, 19, &ed, &f64)) {
  ...
  if (PDC_OK == PDC_ebc_fpoint64_read(pdc, &m, 0, 19, &ed, &f64) || ed.errCode != PDC_BAD_PARAM) {
    error(0, "XXX failure: did not get expected BAD_PARAM error XXX");
    return -1;
  }
  NEXT_REC;
  ...
  if (PDC_OK == PDC_ebc_ufpoint64_read(pdc, &m, 21, 19, &ed, &uf64) || ed.errCode != PDC_BAD_PARAM) {
    error(0, "XXX failure: did not get expected BAD_PARAM error XXX");
    return -1;
  }
  NEXT_REC;

  if (PDC_OK == PDC_ebc_ufpoint64_read(pdc, &m, 20, 19, &ed, &uf64)) {

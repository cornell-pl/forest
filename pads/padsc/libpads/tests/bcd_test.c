...
int main(int argc, char** argv) {
  ...
  if (PDC_OK == PDC_bcd_int8_read(pdc, &em, 3, &ed, &i8)) {
  ...
  if (PDC_OK == PDC_bcd_uint8_read(pdc, &em, 3, &ed, &u8)) {
  ...
  if (PDC_OK == PDC_bcd_int16_read(pdc, &em, 5, &ed, &i16)) {
  ...
  if (PDC_OK == PDC_bcd_uint16_read(pdc, &em, 5, &ed, &u16)) {
  ...
  if (PDC_OK == PDC_bcd_int32_read(pdc, &em, 11, &ed, &i32)) {
  ...
  if (PDC_OK == PDC_bcd_int32_read(pdc, &em, 10, &ed, &i32)) {
    error(0, "Read bcd integer: %ld", (long)i32);
  ...
  if (PDC_OK == PDC_bcd_uint32_read(pdc, &em, 10, &ed, &u32)) {
  ...
  if (PDC_OK == PDC_bcd_int64_read(pdc, &em, 19, &ed, &i64)) {
  ...
  if (PDC_OK == PDC_bcd_uint64_read(pdc, &em, 20, &ed, &u64)) {

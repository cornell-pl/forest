...
int main(int argc, char** argv) {
  ...
  out_sum_data_line_m   dline_m = {P_Ignore,{P_Ignore,P_Ignore},{P_Ignore,P_Ignore},{{P_Ignore,P_Ignore},{P_Ignore,P_Ignore}},{{P_Ignore,P_Ignore},{P_Ignore,P_Ignore}},{P_Ignore,P_Ignore},{{P_Ignore,P_Ignore},{P_Ignore,P_Ignore}},{{P_Ignore,P_Ignore},{P_Ignore,P_Ignore}},P_Ignore,{{P_Ignore,P_Ignore,P_Ignore},P_Ignore},{{P_Ignore,P_Ignore},{P_Ignore,P_Ignore}},{{P_Ignore,P_Ignore},{P_Ignore,P_Ignore}},{{P_Ignore,P_Ignore},{P_Ignore,P_Ignore}},{P_Ignore,P_Ignore},P_Ignore};

  /* all we are interested in is the state field: */
  dline_m.events.element.state = P_CheckAndSet;
  ...
  switch (b) {
    ...
    case count_first21: {
      while (!P_io_at_eof(pads)) {
	if (P_OK == out_sum_data_line_read_internal (pads, &dline_m, &dline_pd, &dline)) {

...
Punion _bnf_75_t {
  byte_range_spec_t _bnf_229;
  suffix_byte_range_spec_t _bnf_230;
};
Pstruct _bnf_231_t {
  commas_t commas;
  _bnf_75_t _bnf_75;
...
Ptypedef Pstring_ME(:"/[[:DIGIT:]]{4}/":) _bnf_85_t;
...
Punion _bnf_110_t {
  message_qop_t _bnf_281;
  Pvoid(_bnf_282);
};
Punion _bnf_111_t {
  nonce_count_t _bnf_283;
  Pvoid(_bnf_284);
};
Punion _bnf_112_t {
  auth_param_t _bnf_285;
  Pvoid(_bnf_286);
};
Punion _bnf_106_t {
  username_t _bnf_287;
...
Punion _bnf_127_t {
  general_header_t _bnf_307;
  response_header_t response_header;
  entity_header_t _bnf_308;
};
Pstruct _bnf_309_t {
  _bnf_127_t _bnf_127;
  CRLF_t CRLF;

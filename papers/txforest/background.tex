...
modeled waterflow out of the region (\cd{RCH\_f}),
...
directory, \cd{Swat\_d}.  This description of this directory
starts with the master watershed file, which has internal name
\cd{cio}, on-disk name \cd{file.cio}, and a file format
described by \cd{Preamble\_f}.  The next component of the
directory is the \cd{basin} field, which XXX (landing in Boston...)

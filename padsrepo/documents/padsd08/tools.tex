...
name of the tool (\eg{}, \cd{provtrack} and \cd{rss}). The body of each tool specification 
...
In the following paragraphs, we describe some of the tools we have implemented.
...
\figref{fig:acc} shows portions of provenance tracker output
...
data from a feed into an RRD.
Users specify a function to transform
feed items into numeric values and RRD parameters such as data source 
...
supports time-indexed queries and graphing of historical data.

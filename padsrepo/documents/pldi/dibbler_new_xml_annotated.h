/*@FILE @LEFT dibbler_xml.tex dibbler_galax.tex*/
...
PDCI_node_t *zip_t_node_new (PDCI_node_t *parent,char const *name,void *m,void *pd,void *rep,char const *kind,char const *whatfn);

PDCI_node_t *zip_t_cachedNode_init (PDCI_node_t *self);

PDCI_node_t *zip_t_node_kthChild (PDCI_node_t *self,PDCI_childIndex_t idx);

PDCI_node_t *zip_t_node_kthChildNamed (PDCI_node_t *self,PDCI_childIndex_t idx,char const *name);

PDCI_node_t *zip_t_cachedNode_kthChild (PDCI_node_t *self,PDCI_childIndex_t idx);

PDCI_node_t *zip_t_sndNode_init (PDCI_node_t *self,PDCI_manager_t *manager,PDCI_childIndex_t ancestor_idx,PDCI_gen_t gen,PDCI_childIndex_t idx);

PDCI_node_t *zip_t_sndNode_kthChild (PDCI_node_t *self,PDCI_childIndex_t idx);

Perror_t zip_t_node_pathWalk (P_t *pads,zip_t_m *m,zip_t_pd *pd,zip_t *rep,PDCI_path_t path,void **m_out,void **pd_out,void **rep_out);
extern PDCI_vtable_t const zip_t_node_vtable;
extern PDCI_vtable_t const zip_t_cachedNode_vtable;
extern PDCI_vtable_t const zip_t_sndNode_vtable;
...
PDCI_node_t *eventSeq_t_node_new (PDCI_node_t *parent,char const *name,void *m,void *pd,void *rep,char const *kind,char const *whatfn);

PDCI_node_t *eventSeq_t_cachedNode_init (PDCI_node_t *self);

PDCI_node_t *eventSeq_t_node_kthChild (PDCI_node_t *self,PDCI_childIndex_t idx);

PDCI_node_t *eventSeq_t_node_kthChildNamed (PDCI_node_t *self,PDCI_childIndex_t idx,char const *name);

PDCI_node_t *eventSeq_t_cachedNode_kthChild (PDCI_node_t *self,PDCI_childIndex_t idx);

PDCI_node_t *eventSeq_t_sndNode_init (PDCI_node_t *self,PDCI_manager_t *manager,PDCI_childIndex_t ancestor_idx,PDCI_gen_t gen,PDCI_childIndex_t idx);

PDCI_node_t *eventSeq_t_sndNode_kthChild (PDCI_node_t *self,PDCI_childIndex_t idx);

Perror_t eventSeq_t_node_pathWalk (P_t *pads,eventSeq_t_m *m,eventSeq_t_pd *pd,eventSeq_t *rep,PDCI_path_t path,void **m_out,void **pd_out,void **rep_out);
extern PDCI_vtable_t const eventSeq_t_node_vtable;
extern PDCI_vtable_t const eventSeq_t_cachedNode_vtable;
extern PDCI_vtable_t const eventSeq_t_sndNode_vtable;
typedef struct entry_t_s entry_t;
typedef struct entry_t_m_s entry_t_m;
typedef struct entry_t_pd_s entry_t_pd;
struct entry_t_m_s {
  Pbase_m compoundLevel;
  order_header_t_m h;		/* nested constraints */
  eventSeq_t_m events;		/* nested constraints */
};
struct entry_t_pd_s {
  Pflags_t pstate;
  Puint32 nerr;
...
PDCI_node_t *entry_t_sndNode_init (PDCI_node_t *self,PDCI_manager_t *manager,

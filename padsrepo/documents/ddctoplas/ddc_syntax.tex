...
%\edcom{M: reword to not be specific to parsing semantics: }
...
%\edcom{Mention why no kinds $\kind \iarrowi \kind$.}

The most basic types are $\ptrue$ and $\pfalse$. The former describes
the empty string while the latter describes no string, failing on all input.
\edcom{S: explain why need both unit and bottom.}

...
\\
\name{} \meta{cs} \::= c \| c\;\mcd{of}\;T \cvb \nont{cs}
\\
\name{} \meta{ccs} \::= 
  \nont{pat} \Rightarrow c \nlalt
...
\subsection{Syntax of Transform Terms and their Types}
...
\nlalt \mcd{let}\;pat = M_1\;\mcd{in}\;M_2           \descr{computation in host language}
...
\nlalt \precord{ \nont{ffps} }                  \descr{\core{} record}
\nlalt c                                       \descr{const constructor}

...
This appendix contains contains \forest{} descriptions of a variety of
different \filestores{}. The material in this appendix is best viewed
electronically.  Some of the generated graphs are very large, but have
been shrunk to fit on a single page.  They will not display well when
printed.  However, readers may zoom in electronically on the PDF to
view the details.
...
%\end{figure}
\newpage
\subsection{Students.hs Description}
